...
fluxion_startup() {
  ...
  sleep 0.1
  local -r fluxionRepository="https://github.com/iXluda-Tech/fluxionX"
  ...
  local -r credits="by$CCyn iXluda-Tech$CClr"
  ...
  if [ ! "$FLUXIONAuto" ]; then
    ...
    local -r fluxionPath="iXluda-Tech/fluxionX/main/fluxion.sh"
    local -r updateDomain="github.com"
    local -r updatePath="iXluda-Tech/fluxionX/archive/main.zip"
